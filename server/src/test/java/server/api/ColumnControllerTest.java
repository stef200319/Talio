...
//        ResponseEntity<String> ret = columnController.deleteColumn(1L);
//        assertEquals(ResponseEntity.ok("Column deleted successfully"), ret);
//    }
//
//    @Test
//    void removeColumnNotFound() {
//        ResponseEntity<String> ret = columnController.deleteColumn(1000);
//        assertEquals(ResponseEntity.notFound().build(), ret);
//    }
//
//    @Test
...
//        ResponseEntity<String> ret = columnController.editColumnTitle(2, "Test3");
//
...
//        ResponseEntity<String> ret = columnController.editColumnTitle(1000, "Test3");
//
//        assertEquals(ResponseEntity.notFound().build(), ret);
//    }
//
